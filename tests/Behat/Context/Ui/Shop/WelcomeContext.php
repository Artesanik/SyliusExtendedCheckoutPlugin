...
namespace Tests\Artesanik\SyliusExtendedCheckoutPlugin\Behat\Context\Ui\Shop;

use Behat\Behat\Context\Context;
use Tests\Artesanik\SyliusExtendedCheckoutPlugin\Behat\Page\Shop\WelcomePageInterface;
